...
- ✔️ Utilização AndroidStudio.
- ✔️ Integrações back-end com ReactNative.
...
### Um agradecimento em especial ao nosso querido __Jackson__ por todos seus conhecimentos em JavaScript e o empenho constante em trazer melhorias ao código o que facilitou em 80% nosso desenvolvimento. (posteriormente pago um pack de cerveja 🍺🍺). 🚀
